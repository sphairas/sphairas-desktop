 ...
 */
public abstract class AbstractImportTargetsItem extends ImportTargetsItem {
...
//    private XmlImportTarget xmlimptarget;
    ...
    public AbstractImportTargetsItem(String sourceNode, DocumentId id, boolean fragment) {
        super(sourceNode);
        this.document = id;
...
//        }
    ...
    public static class Filter implements UpdaterFilter<AbstractImportTargetsItem, TargetDocumentProperties> {

        @Override
        public boolean accept(AbstractImportTargetsItem iti) {
