...
class TargetDownloadSelectActionPanel extends JPanel implements StringValue {

    final DefaultComboBoxModel<Term> termBoxModel = new DefaultComboBoxModel<>();
    final DefaultComboBoxModel<TargetDocumentDownloadAction> delegateBoxModel = new DefaultComboBoxModel<>();
    private final StringValue termStringValue = v -> v instanceof Term ? ((Term) v).getDisplayName() : " ";

    private TargetDownloadSelectActionPanel() {
        initComponents();
    ...
    public String getString(Object value) {
        final TargetDocumentDownloadAction ac = (TargetDocumentDownloadAction) value;
        return ac.getDisabledName();
    }

    @Override
    public String getName() {
        return NbBundle.getMessage(TargetDownloadSelectActionPanel.class, "DownloadSelectActionPanel.step.name");
    }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(typeLabel, org.openide.util.NbBundle.getMessage(TargetDownloadSelectActionPanel.class, "TargetDownloadSelectActionPanel.typeLabel.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(termLabel, org.openide.util.NbBundle.getMessage(TargetDownloadSelectActionPanel.class, "TargetDownloadSelectActionPanel.termLabel.text")); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(termComboBox, 0, 235, Short.MAX_VALUE)
    ...
    private javax.swing.JComboBox<TargetDocumentDownloadAction> delegateComboBox;
    ...
    static class DownloadSelectActionPanelWizardPanel implements WizardDescriptor.Panel<WizardDescriptor> {
        ...
        private TargetDownloadSelectActionPanel component;

        @Override
        public TargetDownloadSelectActionPanel getComponent() {
            if (component == null) {
                component = new TargetDownloadSelectActionPanel();
            }
            return component;
        }
        ...
        public void readSettings(WizardDescriptor wiz) {
            ...
            final TargetDownloadSelectAction ac = (TargetDownloadSelectAction) wiz.getProperty(TargetDownloadSelectAction.ACTION);
            ...
            Term t = (Term) wiz.getProperty(TargetDownloadSelectAction.TERM);
            if (t == null) {
            ...
            final TargetDocumentDownloadAction del = (TargetDocumentDownloadAction) wiz.getProperty(TargetDownloadSelectAction.DELEGATE);
            if (del != null) {
        ...
        public void storeSettings(WizardDescriptor wiz) {
            wiz.putProperty(TargetDownloadSelectAction.TERM, (Term) getComponent().termBoxModel.getSelectedItem());
            wiz.putProperty(TargetDownloadSelectAction.DELEGATE, (TargetDocumentDownloadAction) getComponent().delegateBoxModel.getSelectedItem());
        }
