 ...
 */
@NbBundle.Messages({"ImportLehrerVisualPanel.step.name=Lehrer importieren"})
class UntisSigneeImportVisualPanel extends JPanel {

    final UntisSigneeImportTableModel model = new UntisSigneeImportTableModel();

    UntisSigneeImportVisualPanel() {
        initComponents();
    ...
    public String getName() {
        return NbBundle.getMessage(UntisSigneeImportVisualPanel.class, "ImportLehrerVisualPanel.step.name");
    }
    ...
    static class UntisSigneeImportPanel implements WizardDescriptor.Panel<UntisImportData> {
         ...
         */
        private UntisSigneeImportVisualPanel component;
        ...
        @Override
        public UntisSigneeImportVisualPanel getComponent() {
            if (component == null) {
                component = new UntisSigneeImportVisualPanel();
            }
            return component;
        }
