...
import org.thespheres.betula.xmlimport.config.CommonImportPropertiesTableModel.AppResourcesConfigColFactory;

/**
 *
 * @author boris.heithecker
 */
public class CommonImportPropertiesTableModel extends AbstractPluggableTableModel<AppResourcesProperties, AppResourcesProperty, PluggableTableColumn<AppResourcesProperties, AppResourcesProperty>, AppResourcesConfigColFactory> implements ChangeListener {

    private CommonImportPropertiesTableModel(final Set<? extends PluggableTableColumn<AppResourcesProperties, AppResourcesProperty>> s) {
        super("CommonImportPropertiesTableModel", s);
    }

    static CommonImportPropertiesTableModel create(final String mime) {
        ...
        MimeLookup.getLookup(mime)
                ...
                .forEach(s::add);
        return new CommonImportPropertiesTableModel(s);
    }
