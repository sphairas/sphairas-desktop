...
@MultiViewElement.Registration(mimeType = ZeugnisBemerkungenEnv.MIME,
        persistenceType = TopComponent.PERSISTENCE_ALWAYS,
        displayName = "#ZeugnisMarkerTopComponent.name",
        preferredID = "ZeugnisMarkerTopComponent",
        position = 1000)
@Messages({"ZeugnisMarkerTopComponent.name=Zeugnisbemerkungen",
    "ZeugnisMarkerTopComponent=Zeugnisbemerkungen - {0} {1} {2})"})
public final class ZeugnisMarkerTopComponent extends TopComponent implements MultiViewElement {
    ...
    public ZeugnisMarkerTopComponent() {
        ...
        setName(NbBundle.getMessage(ZeugnisMarkerTopComponent.class, "ZeugnisMarkerTopComponent.name"));
    }
    ...
    private void initComponents() {
        ...
        fill = new javax.swing.Box.Filler(new java.awt.Dimension(0, 0), new java.awt.Dimension(2, 0), new java.awt.Dimension(0, 0));
        ...
        toolbar.add(markerComboBox);

        org.openide.awt.Mnemonics.setLocalizedText(customNoteButton, org.openide.util.NbBundle.getMessage(ZeugnisMarkerTopComponent.class, "ZeugnisMarkerTopComponent.customNoteButton.text")); // NOI18N
        customNoteButton.setFocusable(false);
        customNoteButton.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        customNoteButton.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        toolbar.add(customNoteButton);
    ...
    public void updateName() {
        ...
        if (currentZeungisSettingsModel != null && model.getCurrentStudent().isPresent()) {
            ...
            try {
                ...
                n = NbBundle.getMessage(ZeugnisMarkerTopComponent.class, "ZeugnisMarkerTopComponent", sd.getRemoteStudent().getFullName(), unit, term.getDisplayName());
            } catch (IOException | IllegalAuthorityException ex) {
            }
        }
        if (n == null) {
            n = NbBundle.getMessage(ZeugnisMarkerTopComponent.class, "ZeugnisMarkerTopComponent.name");
        }
        final String name = n;
...
//            return Utilities.actionsToPopup(ac, context);
    ...
    private class PopupAdapter extends MouseUtils.PopupMouseAdapter {
        ...
        protected void showPopup(MouseEvent e) {
            ...
            if (rap != -1) {
                ...
                pop = ZeugnisMarkerTopComponent.this.createPopup(column, row, p, e);
            }
            if (pop != null) {
                ZeugnisMarkerTopComponent.this.showPopup(p.x, p.y, pop);
                e.consume();
            }
        }
    ...
    private final class ColFactory extends ColumnFactory {
        ...
        @NbBundle.Messages({"ZeugnisMarkerTopComponent.columnHeader.text=Bemerkung",
            "ZeugnisMarkerTopComponent.columnHeader.position=Einordnung"
        })
        @Override
        public void configureTableColumn(TableModel model, TableColumnExt columnExt) {
            ...
            switch (columnExt.getModelIndex()) {
                case 0:
                    ...
                    break;
                case 1:
                    columnExt.setHeaderValue(NbBundle.getMessage(ZeugnisMarkerTopComponent.class, "ZeugnisMarkerTopComponent.columnHeader.text"));
                    break;
                case 2:
                    columnExt.setHeaderValue(NbBundle.getMessage(ZeugnisMarkerTopComponent.class, "ZeugnisMarkerTopComponent.columnHeader.position"));
                    break;
//                default:
//                    break;
            }
