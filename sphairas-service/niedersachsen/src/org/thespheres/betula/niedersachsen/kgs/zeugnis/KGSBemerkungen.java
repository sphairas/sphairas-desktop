...
public class KGSBemerkungen extends AbstractMarkerConvention {

    public static final ResourceBundle BUNDLE = NbBundle.getBundle("org.thespheres.betula.niedersachsen.kgs.zeugnis.Bemerkungen");
    public static final String CONVENTION_NAME = "de.niedersachsen.kgs.zeugnis.bemerkungen";

    public KGSBemerkungen() {
