...
//        final SSLConnectionSocketFactory sslsf = new SSLConnectionSocketFactory(getTrustAllSSLContext(), SSLUtil.SSL_VERSIONS, null, SSLConnectionSocketFactory.getDefaultHostnameVerifier());
...
//        if (sslContext == null) {
//            try {
//                final SSLContext ctx = SSLContext.getInstance(SSLUtil.SSL_VERSIONS);
